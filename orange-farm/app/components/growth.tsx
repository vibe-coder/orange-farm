...
export default function Growth(){
    return(
        <div className="space-y-4 lg:flex-col lg:w-full">
            ...
            <div className="grid gap-4 grid-cols-2 lg:flex ">
                <div className="bg-white rounded-2xl h-36 p-4 grid grid-row-3 flex-1 lg:h-auto">
